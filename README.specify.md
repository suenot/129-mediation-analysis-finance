# Chapter 108: Mediation Analysis для Finance

## Описание

Анализ медиации для понимания механизмов влияния факторов на доходность.
...
1. **Causal Mediation Analysis**
   - URL: https://arxiv.org/abs/1905.04515
   - Год: 2019
...
## Структура
```
108_mediation_analysis_finance/
├── README.specify.md
├── README.md
├── docs/
│   └── ru/
